...
namespace eShopSolution.Data.Migrations
{
    ...
    [Migration("20201226143728_EditError_gitignorefile")]
    partial class EditError_gitignorefile
    {
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "b2aeae45-ea70-4eff-8119-6188be2e5d68",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ea4c080e-7632-434c-9620-aa7dd4dca06d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEF692AWwbYqZPtK8ySIRWLGPY5q6SU9ybOPpVMES6R1QOoqS2bBZ2S5p9SdZsjxR8A==",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 26, 21, 37, 27, 828, DateTimeKind.Local).AddTicks(6715));
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2020, 12, 26, 21, 37, 27, 848, DateTimeKind.Local).AddTicks(3455),
